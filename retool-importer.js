...
;(async function () {
  ...
  async function loadSheetJS () {
    ...
    // Try ESM first to avoid page CSP blocking <script src="https://..."></script>.
    try {
      const esm = await import('https://cdn.sheetjs.com/xlsx-0.20.3/package/xlsx.mjs')
      window.XLSX = esm
      if (window.XLSX) return
    } catch (_) {}

    // Fallback for environments where dynamic import is unavailable.
